...
| **[taggr](https://leinss.xyz/projects/taggr/)** | Self-hosted image tagging with a local LLM (Ollama), so data stays on your machine | Web (self-hosted) |

TobiBoard is released and open source. The rest are in private testing. More on each at **[leinss.xyz](https://leinss.xyz)**.
...
Much of my earlier work was on Ethereum, built at hackathons. Projects I helped ship won prizes from the Ethereum Foundation, ENS, The Graph and Optimism. A few highlights:

- **[zkPaymaster](https://ethglobal.com/showcase/zkpaymaster-dbooj)**, a private ZK account-abstraction paymaster contract · *EF Best ERC-4337, ETHGlobal Paris*
- **[Peer'n Pay](https://ethglobal.com/showcase/peer-n-pay-hc2hz)**, a peer-to-peer Ethereum payments dapp · *ENS Integration Prize, ETHGlobal HackFS*
...
- **[Caffeine Consensus](https://devfolio.co/projects/caffeine-consensus-ee2b)**, account-abstraction contracts and X.509 PKI for gasless enterprise transactions · *2nd place, EthZurich*

Blockchain is not history, though: it is what the current role runs on.
